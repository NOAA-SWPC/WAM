...
!     print *,' i=',i,' eldq=',eldq,' cpdt=',cpdt
!    &,'rtdls=',rtdls,' phil=',phil(i,k),phil(i,k+1)
!    &,' dmse=',dmse,' k=',k
            DMSE    = ELDQ + CPDT + phil(i,k) - phil(i,k+1)
!     print*,' i=',i,' dmse=',dmse,' k=',k
...
!       do i=1,N2
!         ii = index2(i)
!         if (prsi(ii,1)-prsi(ii,k) .le. dpshc(ii)) ktopm(i) = k
!       enddo
!     enddo
!     do i=1,N2
!       ktopm(i) = min(ktopm(i),kinver(index2(i)))
!     enddo
C-----------------------------------------------------------------------
