...
!-------------------------------------------------------------------------------
  subroutine sigio_alhead(head,iret,levs,nvcoord,ntrac)
    implicit none
    type(sigio_head),intent(inout):: head
    integer(sigio_intkind),intent(out):: iret
    integer(sigio_intkind),optional,intent(in):: levs,nvcoord,ntrac
    integer dim1v,dim2v,dim1c
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    if(allocated(head%vcoord)) then
      deallocate(head%vcoord)
    endif
