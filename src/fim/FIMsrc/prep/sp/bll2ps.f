...
cccCDIR$ IVDEP
      ...
      ENDIF
C - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
cCMIC$ DO ALL PRIVATE(K,IJ,J,I,N,JXI,IXI,JX,IX,DJX,DIX,R2)
cCMIC$&       PRIVATE(RLATN,RLONN,RLATS,RLONS)
cCMIC$&       PRIVATE(YN,XN,IN1,IN2,WIN2,WIN1,JN1,JN2,WJN2,WJN1)
cCMIC$&       PRIVATE(YS,XS,IS1,IS2,WIS2,WIS1,JS1,JS2,WJS2,WJS1)
cCMIC$&       PRIVATE(IJN11,IJN21,IJN12,IJN22,IJS11,IJS21,IJS12,IJS22)
cCMIC$&       SHARED(KM,NPS,NXQ,NX,XPX,DPR,G2,ORIENT)
cCMIC$&       SHARED(IM,JM,IBM,B,LB,BN,BS,WN,WS)
      DO IJ=1,NPS*NPS
        J=(IJ-1)/NPS+1
        I=IJ-(J-1)*NPS
cCDIR$ IVDEP
