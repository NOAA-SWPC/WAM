...
!
      ...
      integer icen,icen2,ienst,iensi,iens(5)
...
!
     ...
     &            igen,0,IDT3(nv),ISGLEV,il1,il2,IYR,IMO,IDA,IHR,
     &            IFHOUR,IFHR,ITHR,IAVG,0,0,ICEN2,IDS(IDT3(nv)),IENS,
     &            0.,0.,0.,0.,0.,0.,G,LG,IERR)
         if(ierr.ne.0)print*,'wrt3d gribit_gsm ierr=',ierr,'  ',' nv='
     &,  nv,' K=',K
...
!
      ...
      call unsplit2d_phys(ioproc,wrkga,buffo,global_lats_r)
         ...
         gtn = 2
         if (nv > 3) gtn = 133
         call gribit_gsm(wrkga,LBM,4,lonr,latr,16,CL1,ILPDS,gtn,ICEN,
     &            igen,0,IDQ3(nv),ISGLEV,il1,il2,IYR,IMO,IDA,IHR,
...
!
      ...
      call unsplit2d_phys(ioproc,wrkga,buffo,global_lats_r)
         ...
         if(me.eq.ioproc) then
           ...
           if (nv > 1) gtn = 133
         call gribit_gsm(wrkga,LBM,4,lonr,latr,16,CL1,ILPDS,gtn,ICEN,
     &            igen,0,IDU3(nv),ISGLEV,il1,il2,IYR,IMO,IDA,IHR,
...
!
      ...
      call unsplit2d_phys(ioproc,wrkga,buffo,global_lats_r)
         if(me.eq.ioproc) then
           ...
           if (nv > 1) gtn = 133
         call gribit_gsm(wrkga,LBM,4,lonr,latr,16,CL1,ILPDS,gtn,ICEN,
     &            igen,0,IDV3(nv),ISGLEV,il1,il2,IYR,IMO,IDA,IHR,
...
!
      ...
      call unsplit2d_phys(ioproc,wrkga,buffo,global_lats_r)
        if(me.eq.ioproc) then
        call gribit_gsm(wrkga,LBM,4,lonr,latr,16,CL1,ILPDS,2,ICEN,
     &            igen,0,ICC,ISGLEV,il1,il2,IYR,IMO,IDA,IHR,
     &            IFHOUR,IFHR,ITHR,IAVG,0,0,ICEN2,IDS(ICC),IENS,
     &            0.,0.,0.,0.,0.,0.,G,LG,IERR)
        if(ierr.ne.0)print*,'wrt3d gribit_gsm ierr=',ierr,'  ',' K=',K
...
!
      ...
      if(me.eq.ioproc)then
      call gribit_gsm(wrkga,LBM,4,lonr,latr,16,CL1,ILPDS,2,ICEN,
     &            igen,0,IPRS,ISFC,0,0,IYR,IMO,IDA,IHR,
...
!
     ...
     &            igen,0,ICMF(1),ISGLEV,il1,il2,IYR,IMO,IDA,IHR,
...
!
      ...
      call unsplit2d_phys(ioproc,wrkga,buffo,global_lats_r)
        if(me.eq.ioproc) then
        call gribit_gsm(wrkga,LBM,4,lonr,latr,16,CL1,ILPDS,133,ICEN,
     &            igen,0,ICMF(2),ISGLEV,il1,il2,IYR,IMO,IDA,IHR,
...
!
      ...
      call unsplit2d_phys(ioproc,wrkga,buffo,global_lats_r)
        if(me.eq.ioproc) then
        call gribit_gsm(wrkga,LBM,4,lonr,latr,16,CL1,ILPDS,133,ICEN,
     &            igen,0,ICMF(3),ISGLEV,il1,il2,IYR,IMO,IDA,IHR,
